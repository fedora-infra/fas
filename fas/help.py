...
class Help(controllers.Controller):
    help = { 'none' :               [_('Error'), _('<p>We could not find that help item</p>')],
            ...
            'blog_rss':             [_('RSS blog'), _('''<p>Link to the RSS feed of your blog</p>''')],
            'blog_avatar':          [_('Avatar blog'), _('''<p>Link to the avatar/hackergotchi you would like to use on your blog</p>''')],
            }
